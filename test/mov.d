...
0xBB,0xAA,0x58,0x47,0x36,0x24,0x49,0xBF,0xDD,0xCC,0xBB,0xAA,0x58,0x47,0x36,0x24]);
	...
	// Mov reg8, mem8
	foreach (Reg8 regA; Reg8.min..Reg8Max) codeGen.mov(regA, BytePtr(memAddrDisp32(0x55667788)));
	assertEqualReset([
...
0x88,0x77,0x66,0x55,0x44,0x8A,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg16, mem16
	foreach (Reg16 regA; Reg16.min..Reg16Max) codeGen.mov(regA, WordPtr(memAddrDisp32(0x55667788)));
	assertEqualReset([
...
0x44,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg32, mem32
	foreach (Reg32 regA; Reg32.min..Reg32Max) codeGen.mov(regA, DwordPtr(memAddrDisp32(0x55667788)));
	assertEqualReset([
...
0x44,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg64, mem64
	foreach (Reg64 regA; Reg64.min..Reg64Max) codeGen.mov(regA, QwordPtr(memAddrDisp32(0x55667788)));
	assertEqualReset([
...
0x4C,0x8B,0x34,0x25,0x88,0x77,0x66,0x55,0x4C,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem8, reg8
	foreach (Reg8 regA; Reg8.min..Reg8Max) codeGen.mov(BytePtr(memAddrDisp32(0x55667788)), regA);
	assertEqualReset([
...
0x88,0x77,0x66,0x55,0x44,0x88,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem16, reg16
	foreach (Reg16 regA; Reg16.min..Reg16Max) codeGen.mov(WordPtr(memAddrDisp32(0x55667788)), regA);
	assertEqualReset([
...
0x44,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem32, reg32
	foreach (Reg32 regA; Reg32.min..Reg32Max) codeGen.mov(DwordPtr(memAddrDisp32(0x55667788)), regA);
	assertEqualReset([
...
0x44,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem64, reg64
	foreach (Reg64 regA; Reg64.min..Reg64Max) codeGen.mov(QwordPtr(memAddrDisp32(0x55667788)), regA);
	assertEqualReset([
...
0x4C,0x89,0x34,0x25,0x88,0x77,0x66,0x55,0x4C,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem8, imm8
	codeGen.mov(BytePtr(memAddrDisp32(0x55667788)), Imm8(0xAA));
	assertEqualReset([0xC6,0x04,0x25,0x88,0x77,0x66,0x55,0xAA]);

	// Mov mem16, imm16
	codeGen.mov(WordPtr(memAddrDisp32(0x55667788)), Imm16(0xAABB));
	assertEqualReset([0x66,0xC7,0x04,0x25,0x88,0x77,0x66,0x55,0xBB,0xAA]);

	// Mov mem32, imm32
	codeGen.mov(DwordPtr(memAddrDisp32(0x55667788)), Imm32(0xAABBCCDD));
	assertEqualReset([0xC7,0x04,0x25,0x88,0x77,0x66,0x55,0xDD,0xCC,0xBB,0xAA]);

	// Mov mem64, imm32
	// mov QWORD PTR [rsp-0x8],0xffffffffaabbccdd
	codeGen.mov(QwordPtr(memAddrBaseDisp8(Reg32.ESP, cast(ubyte)(-0x8))), Imm32(0xAABBCCDD)); // -8
