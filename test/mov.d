...
void testMov()
{
	...
	// Mov reg8, reg8
	foreach (Register regA; Register.min..RegisterMax) codeGen.movByte(regA, Register.min);
	foreach (Register regB; Register.min..RegisterMax) codeGen.movByte(Register.min, regB);
	assertEqualReset([
...
0xD0,0x44,0x88,0xD8,0x44,0x88,0xE0,0x44,0x88,0xE8,0x44,0x88,0xF0,0x44,0x88,0xF8]);
	...
	// Mov reg16, reg16
	foreach (Register regA; Register.min..RegisterMax) codeGen.movWord(regA, Register.min);
	foreach (Register regB; Register.min..RegisterMax) codeGen.movWord(Register.min, regB);
	assertEqualReset([
...
0x66,0x44,0x89,0xE0,0x66,0x44,0x89,0xE8,0x66,0x44,0x89,0xF0,0x66,0x44,0x89,0xF8]);
	...
	// Mov reg32, reg32
	foreach (Register regA; Register.min..RegisterMax) codeGen.movDword(regA, Register.min);
	foreach (Register regB; Register.min..RegisterMax) codeGen.movDword(Register.min, regB);
	assertEqualReset([
...
0xD0,0x44,0x89,0xD8,0x44,0x89,0xE0,0x44,0x89,0xE8,0x44,0x89,0xF0,0x44,0x89,0xF8]);
	...
	// Mov reg64, reg64
	foreach (Register regA; Register.min..RegisterMax) codeGen.movQword(regA, Register.min);
	foreach (Register regB; Register.min..RegisterMax) codeGen.movQword(Register.min, regB);
	assertEqualReset([
...
0xD0,0x4C,0x89,0xD8,0x4C,0x89,0xE0,0x4C,0x89,0xE8,0x4C,0x89,0xF0,0x4C,0x89,0xF8]);
	...
	// Mov reg8, imm8
	foreach (Register regA; Register.min..RegisterMax) codeGen.movByte(regA, Imm8(0x24));
	assertEqualReset([
...
0x41,0xB4,0x24,0x41,0xB5,0x24,0x41,0xB6,0x24,0x41,0xB7,0x24]);
	...
	// Mov reg16, imm16
	foreach (Register regA; Register.min..RegisterMax) codeGen.movWord(regA, Imm16(0x2436));
	assertEqualReset([
...
0xBE,0x36,0x24,0x66,0x41,0xBF,0x36,0x24]);
	...
	// Mov reg32, imm32
	foreach (Register regA; Register.min..RegisterMax) codeGen.movDword(regA, Imm32(0x24364758));
	assertEqualReset([
...
0x36,0x24,0x41,0xBF,0x58,0x47,0x36,0x24]);
	...
	// Mov reg64, imm64
	foreach (Register regA; Register.min..RegisterMax) codeGen.movQword(regA, Imm64(0x24364758AABBCCDD));
	assertEqualReset([
...
0xBB,0xAA,0x58,0x47,0x36,0x24,0x49,0xBF,0xDD,0xCC,0xBB,0xAA,0x58,0x47,0x36,0x24]);
	...
	// Mov reg8, mem8
	foreach (Register regA; Register.min..RegisterMax) codeGen.movByte(regA, memAddrDisp32(0x55667788));
	assertEqualReset([
...
0x88,0x77,0x66,0x55,0x44,0x8A,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg16, mem16
	foreach (Register regA; Register.min..RegisterMax) codeGen.movWord(regA, memAddrDisp32(0x55667788));
	assertEqualReset([
...
0x44,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg32, mem32
	foreach (Register regA; Register.min..RegisterMax) codeGen.movDword(regA, memAddrDisp32(0x55667788));
	assertEqualReset([
...
0x44,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov reg64, mem64
	foreach (Register regA; Register.min..RegisterMax) codeGen.movQword(regA, memAddrDisp32(0x55667788));
	assertEqualReset([
...
0x4C,0x8B,0x34,0x25,0x88,0x77,0x66,0x55,0x4C,0x8B,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem8, reg8
	foreach (Register regA; Register.min..RegisterMax) codeGen.movByte(memAddrDisp32(0x55667788), regA);
	assertEqualReset([
...
0x88,0x77,0x66,0x55,0x44,0x88,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem16, reg16
	foreach (Register regA; Register.min..RegisterMax) codeGen.movWord(memAddrDisp32(0x55667788), regA);
	assertEqualReset([
...
0x44,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem32, reg32
	foreach (Register regA; Register.min..RegisterMax) codeGen.movDword(memAddrDisp32(0x55667788), regA);
	assertEqualReset([
...
0x44,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem64, reg64
	foreach (Register regA; Register.min..RegisterMax) codeGen.movQword(memAddrDisp32(0x55667788), regA);
	assertEqualReset([
...
0x4C,0x89,0x34,0x25,0x88,0x77,0x66,0x55,0x4C,0x89,0x3C,0x25,0x88,0x77,0x66,0x55]);
	...
	// Mov mem8, imm8
	codeGen.movByte(memAddrDisp32(0x55667788), Imm8(0xAA));
	assertEqualReset([0xC6,0x04,0x25,0x88,0x77,0x66,0x55,0xAA]);

	// Mov mem16, imm16
	codeGen.movWord(memAddrDisp32(0x55667788), Imm16(0xAABB));
	assertEqualReset([0x66,0xC7,0x04,0x25,0x88,0x77,0x66,0x55,0xBB,0xAA]);

	// Mov mem32, imm32
	codeGen.movDword(memAddrDisp32(0x55667788), Imm32(0xAABBCCDD));
	assertEqualReset([0xC7,0x04,0x25,0x88,0x77,0x66,0x55,0xDD,0xCC,0xBB,0xAA]);

	// Mov mem64, imm32
	// mov QWORD PTR [rsp-0x8],0xffffffffaabbccdd
	codeGen.movQword(memAddrBaseDisp8(Register.SP, cast(ubyte)(-0x8)), Imm32(0xAABBCCDD)); // -8
