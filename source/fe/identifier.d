...
enum CommonIds : Identifier
{
	...
	@("Windows")  id_Windows = Identifier(cash_is_integer.index + 1),
	@("Linux")    id_Linux   = Identifier(cash_is_integer.index + 2),
}
...
enum uint commonId_version_id_last  = CommonIds.id_Linux.index;
